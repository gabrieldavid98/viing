defmodule Viing.Packet.Puback do
  @moduledoc false
  ...
  @spec decode(nonempty_binary()) ::
          {:error, :malformed_packet_error} | {:ok, Viing.Packet.Puback.t()}
  ...
  defimpl Viing.Encoding.Encodable do
    ...
    @spec encode(Viing.Packet.Puback.t()) :: <<_::24, _::_*8>>
    def encode(%Packet.Puback{packet_identifier: packet_identifier} = t) do
